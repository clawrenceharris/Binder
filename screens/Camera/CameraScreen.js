...
const CameraScreen = (props) => {
  ...
  const { chat, callback, useCase, onSendStart, onSendComplete, onSendError } =
    props.route.params;
  ...
  return (
    <View style={[styles.mainContainer, { paddingTop: insets.top }]}>
      <View
        ...
        onResponderRelease={() => {}}
        onResponderGrant={() =>
          doubleTap(500, lastTap, setLastTap, handleDoubleTap)
        }
      >
        {!hasCameraPermission && (
          <View
          ...
          >
            <MediumText h3 white>
              {"Allow Binder to access your camera."}
            </MediumText>
            <Button
              title="Open Settings"
        ...
        >
          ...
          >
            <TouchableOpacity onPress={onFlipPressed}>
              <Image
                ...
                style={[
                  styles.icon,
                  {
                    width: styles.icon.width + 5,
                    height: styles.icon.height + 5,
                  },
                ]}
              />
            </TouchableOpacity>
            ...
            >
              {!flashMode && (
                <Image source={assets.flash_off} style={styles.icon} />
              )}
              {flashMode && <Image source={assets.flash} style={styles.icon} />}
            </TouchableOpacity>

            <TouchableOpacity style={styles.sideBarIcon} onPress={onDeskPress}>
        ...
        <View style={styles.bottomContianer}>
              ...
              {mediaCollection.map((uri) => (
                <View style={styles.imageContainer}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      setMediaCollection(
                        mediaCollection.filter((item) => item != uri)
                      )
                    }
                    style={{
                      borderRadius: 25,
          ...
          >
              ...
              >
                <Image
                  ...
                  style={{
                    ...
                    marginHorizontal: 15,
                    tintColor:
                      mediaCollection.length == 4
                        ? Colors.light.veryDarkGray
                        : null,
                  }}
                />
              </TouchableOpacity>
            ...
            {useCase == "multiple photos to use" && (
              <TouchableOpacity
                onPress={() => {
