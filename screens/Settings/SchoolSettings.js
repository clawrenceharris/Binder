    ...
    <View style={{ flex: 1, backgroundColor: Colors[colorScheme].background }}>
          ...
          slides={[
            {
              ...
              message:
                "Leave " +
                props.route.params.school?.name +
                "? You won't be able to see your chats made within this school anymore.",
              confirmText: "Leave",
            ...
            },
            {
              title: "",
              message:
                "Do you want to keep your friends and study buddies made in " +
                props.route.params.school?.name +
                "?",
      ...
      <View style={styles.mainContainer}>
        <RegularText
          style={[
            styles.description,
            { color: Colors[colorScheme].darkGray, marginBottom: 30 },
          ]}
        >
          {descriptions.school}
        </RegularText>
      ...
      {useCase == "settings" && (
        <BottomBarButton
          ...
          disabled={
            !school ||
            (props.route.params.school?.id &&
              school?.id == props.route.params.school?.id)
          }
          onPress={onSavePress}
          loading={loading}
        />
