...
import EditDeskItemB from "./screens/EditDeskItemB";
import EditGame from "./screens/EditGame";
import EditDeskItemA from "./screens/EditDeskItemA";
    ...
    return (
      <SafeAreaProvider>
        ...
        <Notification show={showNotification}>
          <RegularText white h5 style={{ textAlign: "center" }}>
            {notification}
          </RegularText>
        </Notification>
          ...
          <NavigationContainer>
            ...
            >
              <Stack.Group screenOptions={{ headerShown: false }}>
                ...
                <Stack.Screen name="SignUpSchool" component={SignUpSchool} />
                ...
                <Stack.Screen
                  name="EditMediaToSend"
                  component={EditMediaToSend}
                  options={{
                    animation: "none",
        ...
        <Provider store={store}>
          <NavigationContainer>
            ...
            >
              ...
              />
              <Stack.Screen
                name="NewBurningQuestion"
                component={NewBurningQuestion}
              />
              <Stack.Screen
